...
const addStickerMetadata = async (stickerBuffer, packname, author) => {
  try {
    ...
    const metadata = {
      'sticker-pack-name': packname || 'Made by shyam',
      'sticker-pack-publisher': author || 'Dex-mini-bot'
    };
 ...
 */
const createSticker = async (mediaBuffer, isVideo = false, packname = 'Made by shyam', author = 'Dex-mini-bot') => {
  try {
