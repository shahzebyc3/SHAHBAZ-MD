...
const DEFAULT_SETTINGS = {
    ...
    responses: {
        greetings: {
            ...
            replies:  ['Hello! How can I help you today?', 'Hi there! What can I do for you?', 'Hey! SHAHBAZ MD at your service.']
        },
        thanks: {
        ...
        botInfo: {
            ...
            replies:  ["I'm SHAHBAZ MD Bot, an advanced WhatsApp assistant by SHAHBAZ Tech Inc."]
        },
        creator: {
            ...
            try {
                await sock.sendMessage(jid, {
                    ...
                    contextInfo: {
                        ...contextInfo,
                        externalAdReply: {
                            title:        (getStr('botName') || 'SHAHBAZ-MD') + ' Auto-Reply',
                            body:         'Intelligent response system',
                            thumbnailUrl: getStr('pic1') || 'https://files.catbox.moe/l7d81a.png',
                            mediaType:    1
                        }
                    }
                }, { quoted: message });
