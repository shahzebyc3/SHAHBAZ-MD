...
module.exports = {
    ...
    run: async (sock, message, args, { sender, jid, contextInfo }) => {
        ...
        const ownerName   = config.OWNER_NAME || '✦ SHAHBAZ✦ MD ✦';
        ...
        await sock.sendMessage(sender, {
            ...
            contextInfo: {
                ...
                externalAdReply: {
                    ...
                    thumbnailUrl: config.ALIVE_IMG || 'https://files.catbox.moe/l7d81a.png',
                    sourceUrl: 'https://github.com/shahzebyc3/SHAHBAZ-MD',
                    mediaType: 1,
